        ...
        <section className="celebration-layout" aria-live="polite">
          ...
          <div className="celebration-card">
            ...
            <p className="love-note">
              I know you are not ready for dating, and I respect that. This is just my little surprise showing how special you are to me, and I love you with patience, care, and zero pressure. 💖😘💋
            </p>
