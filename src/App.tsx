        ...
        <section className="celebration-layout" aria-live="polite">
          ...
          <div className="celebration-card">
            ...
            <p className="love-note">
              I know you are not ready for dating, and I respect that. This is just my little program saying you are special to me, and I love you with patience, care, and zero pressure. Can't wait to start building more for you. 💖😘💋
            </p>
